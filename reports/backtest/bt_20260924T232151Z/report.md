# Backtest report `bt_20260924T232151Z`

Generated 2026-09-24T23:21:51.915073+00:00 (UTC). Code hash `8469776ce49b`. Folds (walk-forward, expanding window): [2022, 2023, 2024]. Locked test season 2025 not evaluated.
...
|---|---|---|---|---|---|---|
| final | B_football_ridge | A_market_raw | ae_margin | 854 | +0.319 | [+0.158, +0.491] |
| final | B_football_ridge | A_market_raw | ae_total | 854 | +0.366 | [+0.160, +0.572] |
| final | B_football_ridge | A_market_raw | se_margin | 854 | +9.607 | [+4.545, +14.874] |
| final | B_football_ridge | A_market_raw | se_total | 854 | +9.658 | [+4.710, +14.720] |
| final | B_football_ridge | A_market_cal | ae_margin | 854 | +0.308 | [+0.149, +0.482] |
| final | B_football_ridge | A_market_cal | ae_total | 854 | +0.364 | [+0.161, +0.563] |
| final | B_football_ridge | A_market_cal | se_margin | 854 | +9.209 | [+4.328, +14.447] |
| final | B_football_ridge | A_market_cal | se_total | 854 | +9.811 | [+4.956, +14.733] |
| final | A_market_cal | A_market_raw | ae_margin | 854 | +0.011 | [-0.002, +0.024] |
| final | A_market_cal | A_market_raw | ae_total | 854 | +0.002 | [-0.007, +0.012] |
| final | A_market_cal | A_market_raw | se_margin | 854 | +0.398 | [+0.060, +0.688] |
| final | A_market_cal | A_market_raw | se_total | 854 | -0.154 | [-0.382, +0.080] |
| final | B_football_ridge | N_naive_home | ae_margin | 854 | -0.817 | [-1.076, -0.557] |
| final | B_football_ridge | N_naive_home | ae_total | 854 | -0.324 | [-0.595, -0.071] |
| final | B_football_ridge | N_naive_home | se_margin | 854 | -25.078 | [-33.886, -16.755] |
| final | B_football_ridge | N_naive_home | se_total | 854 | -9.231 | [-16.118, -2.140] |
| early | B_football_ridge | N_naive_home | ae_margin | 854 | -0.817 | [-1.072, -0.544] |
| early | B_football_ridge | N_naive_home | ae_total | 854 | -0.323 | [-0.577, -0.065] |
| early | B_football_ridge | N_naive_home | se_margin | 854 | -25.070 | [-34.069, -16.628] |
| early | B_football_ridge | N_naive_home | se_total | 854 | -9.223 | [-16.177, -2.729] |
